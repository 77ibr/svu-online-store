...
class __TwigTemplate_5fc9c4651907db5a914e9175cc42eef0c07b6385e69376afa6a306f78852a7d8 extends Template
{
    private $source;
    private $macros = [];
...
\$('#button-buy').on('click', function(e) {
    ...
    html += '          <div class=\"text-end\"><a href=\"https://www.opencart.com/index.php?route=support/contact\" class=\"btn btn-light btn-lg\" target=\"_blank\">";
        ...
        echo "</a></div>';
    html += '          <button type=\"button\" id=\"button-purchase\" data-oc-loading-text=\"";
        // line 185
...
\$('body').on('click', '#modal-purchase #button-purchase', function(e) {
    ...
    \$.ajax({
        ...
        success: function(json) {
            ...
            if (json['error']) {
                \$('#modal-purchase .modal-body').prepend('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fas fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div>');
            }
...
\$('#tab-download').on('click', '.btn-primary', function(e) {
    ...
    \$.ajax({
        ...
        success: function(json) {
            ...
            if (json['error']) {
                \$('#download').before('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fas fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div></div>');
            }

            if (json['success']) {
                \$('#download').before('<div class=\"alert alert-success alert-dismissible\"><i class=\"fas fa-check-circle\"></i> ' + json['success'] + '  <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div>');
...
\$('#button-comment').on('click', function() {
    \$.ajax({
        ...
        success: function(json) {
            ...
            if (json['error']) {
                \$('#tab-comment').prepend('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fas fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div>');
            }

            if (json['success']) {
                \$('#tab-comment').prepend('<div class=\"alert alert-success alert-dismissible\"><i class=\"fas fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div>');
...
\$('#comment').on('click', '.btn-primary', function(e) {
    ...
    \$.ajax({
        ...
        success: function(json) {
            ...
            if (json['error']) {
                \$(element).parents('.reply-input-box').before('<div class=\"alert alert-danger alert-dismissible\"><i class=\"fas fa-exclamation-circle\"></i> ' + json['error'] + ' <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div>');
            }

            if (json['success']) {
                \$(element).parents('.reply-input-box').before('<div class=\"alert alert-success alert-dismissible\"><i class=\"fas fa-check-circle\"></i> ' + json['success'] + ' <button type=\"button\" class=\"btn-close\" data-bs-dismiss=\"alert\"></button></div>');
...
";
    ...
    {
        return array (  758 => 452,  636 => 335,  611 => 315,  601 => 310,  580 => 294,  516 => 235,  501 => 225,  474 => 203,  451 => 185,  447 => 184,  441 => 181,  437 => 180,  432 => 178,  428 => 177,  421 => 173,  389 => 144,  366 => 130,  357 => 126,  351 => 125,  342 => 123,  332 => 118,  324 => 115,  316 => 110,  312 => 109,  305 => 105,  301 => 104,  287 => 99,  280 => 98,  276 => 97,  272 => 96,  265 => 92,  261 => 91,  257 => 90,  251 => 86,  245 => 84,  239 => 82,  237 => 81,  233 => 80,  230 => 79,  224 => 77,  222 => 76,  210 => 67,  202 => 62,  196 => 59,  191 => 57,  182 => 51,  176 => 48,  172 => 47,  164 => 44,  160 => 43,  156 => 42,  152 => 41,  148 => 39,  133 => 37,  129 => 36,  126 => 35,  116 => 33,  114 => 32,  107 => 28,  104 => 27,  96 => 23,  94 => 22,  88 => 18,  77 => 16,  73 => 15,  68 => 13,  60 => 11,  54 => 9,  48 => 7,  46 => 6,  37 => 1,);
    }

    public function getSourceContext()
    {
        return new Source("", "admin/view/template/marketplace/marketplace_info.twig", "C:\\xampp\\htdocs\\opencart\\upload\\admin\\view\\template\\marketplace\\marketplace_info.twig");
    }
}
