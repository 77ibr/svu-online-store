...
class __TwigTemplate_b9269fab8579de22c9a3a22bc0abeac44bc3832be9630fd063c0f92fad2d122c extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t\t\t\t<td class=\"text-end text-nowrap\"><button type=\"button\" data-oc-description=\"";
                // line 25
                echo twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "description", [], "any", false, false, false, 25);
                echo "\" data-oc-trigger=\"";
                echo twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "trigger", [], "any", false, false, false, 25);
                echo "\" data-oc-action=\"";
                echo twig_get_attribute($this->env, $this->source, ($context["event"] ?? null), "action", [], "any", false, false, false, 25);
...
\t\t\t\t\t\t\t\t<button type=\"button\" value=\"";
                ...
                echo "\" class=\"btn btn-warning\"><i class=\"fas fa-play\"></i></button>
\t\t\t\t\t\t\t\t";
                // line 27
...
\t</div>
    ...
    {
        return new Source("", "admin/view/template/marketplace/cron_list.twig", "C:\\xampp\\htdocs\\opencart\\upload\\admin\\view\\template\\marketplace\\cron_list.twig");
    }
}
