...
class __TwigTemplate_6578bffb666fe00d09ab90e6ecc70657d59e9fb2d5ceb57e0d9be591d1964bcd extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<button type=\"submit\" form=\"form-store\" formaction=\"";
        ...
        echo "') ? \$('#form-store').submit() : false;\" class=\"btn btn-danger\"><i class=\"fas fa-trash-alt\"></i></button>
\t\t\t</div>
\t\t\t<h1>";
        // line 8
...
";
    ...
    {
        return new Source("", "admin/view/template/setting/store.twig", "C:\\xampp\\htdocs\\opencart\\upload\\admin\\view\\template\\setting\\store.twig");
    }
}
