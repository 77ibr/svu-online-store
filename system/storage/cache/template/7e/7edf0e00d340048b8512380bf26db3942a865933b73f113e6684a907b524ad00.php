...
class __TwigTemplate_b37a6ab78a78c66c02f0fd2379c675b0552c1f8a3d696f19e67540ab873d6622 extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<button type=\"submit\" form=\"form-event\" formaction=\"";
        ...
        echo "') ? \$('#form-event').submit() : false;\" class=\"btn btn-danger\"><i class=\"fas fa-trash-alt\"></i></button>
\t\t\t</div>
\t\t\t<h1>";
        // line 8
...
";
    ...
    {
        return new Source("", "admin/view/template/marketplace/event.twig", "C:\\xampp\\htdocs\\opencart\\upload\\admin\\view\\template\\marketplace\\event.twig");
    }
}
