...
class __TwigTemplate_1254f9546d5e85f4b124838810c5b53745a6bcfc6453424ac06f29ae7ec0266f extends Template
{
    private $source;
    private $macros = [];
...
\t\t\t\t<button type=\"submit\" form=\"form-startup\" formaction=\"";
        ...
        echo "') ? \$('#form-startup').submit() : false;\" class=\"btn btn-danger\"><i class=\"fas fa-trash-alt\"></i></button>
\t\t\t</div>
\t\t\t<h1>";
        // line 8
...
";
    ...
    {
        return new Source("", "admin/view/template/marketplace/startup.twig", "C:\\xampp\\htdocs\\opencart\\upload\\admin\\view\\template\\marketplace\\startup.twig");
    }
}
